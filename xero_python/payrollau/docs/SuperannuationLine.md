...
**minimum_monthly_earnings** | **float** | Superannuation minimum monthly earnings. Deprecated: it only applies to pay runs with a payment date before 1 July 2022. | [optional] 
